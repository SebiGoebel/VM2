...
int main(int argc, char *argv[])
{
    ...
    */
    ...
    auto current_pose_start = move_group_interface.getCurrentPose();
    double target_x = 0.0;
    double target_y = 0.4;
    double target_z = 0.3;
    ...
    if (visualizeArea)
    {
        ...
        testbox1_pose.orientation = euler2Quaternion_deg(0, 0, -13);
        testbox1_pose.position.x = (target_x - current_pose_start.pose.position.x) / 2 + current_pose_start.pose.position.x + 0.15;
        testbox1_pose.position.y = (target_y - current_pose_start.pose.position.y) / 2 + current_pose_start.pose.position.y;
        testbox1_pose.position.z = (target_z - current_pose_start.pose.position.z) / 2 + current_pose_start.pose.position.z;
    ...
    primitive_box_constraint1.dimensions = {0.5, 0.9, 0.5};
    ...
    constraint_box_pose1.position.x = (target_x - current_pose_start.pose.position.x) / 2 + current_pose_start.pose.position.x + 0.15;
    constraint_box_pose1.position.y = (target_y - current_pose_start.pose.position.y) / 2 + current_pose_start.pose.position.y;
    constraint_box_pose1.position.z = (target_z - current_pose_start.pose.position.z) / 2 + current_pose_start.pose.position.z;
    constraint_box_pose1.orientation = euler2Quaternion_deg(0, 0, -13);
    ...
    */
    ...
    //    msg.position.y = target_y; // 0.5
    //    msg.position.z = target_z; // 0.25
    //    return msg;
    //}();

...
int main(int argc, char *argv[])
{
    ...
    */
    ...
    if (visualizeArea)
    {
        ...
        testbox1_pose.position.x = current_pose_start.pose.position.x;
        testbox1_pose.position.y = current_pose_start.pose.position.y;
        testbox1_pose.position.z = current_pose_start.pose.position.z;
    ...
    primitive_box_constraint1.dimensions = {0.005, 2.0, 2.0};
    ...
    constraint_box_pose1.position.x = current_pose_start.pose.position.x;
    constraint_box_pose1.position.y = current_pose_start.pose.position.y;
    constraint_box_pose1.position.z = current_pose_start.pose.position.z;

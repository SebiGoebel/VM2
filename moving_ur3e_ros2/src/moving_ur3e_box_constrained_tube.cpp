...
int main(int argc, char *argv[])
{
    ...
    */
    ...
    if (visualizeArea)
    {
        ...
        testbox1_pose.orientation = euler2Quaternion_deg(-77, 0.0, -12.0);
        testbox1_pose.position.x = 0.0;
    ...
    primitive_box_constraint1.dimensions = {0.25, 0.25, 0.9};
    ...
    constraint_box_pose1.position.x = 0.0;
    constraint_box_pose1.position.y = 0.1;
    constraint_box_pose1.position.z = 0.3;
    constraint_box_pose1.orientation = euler2Quaternion_deg(-77, 0.0, -12.0);

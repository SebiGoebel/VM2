...
int main(int argc, char *argv[])
{
    ...
    */
    ...
    if (visualizeArea)
    {
        ...
        // test box 1
        moveit_msgs::msg::CollisionObject testbox1;
        testbox1.header.frame_id = move_group_interface.getPlanningFrame();
        testbox1.id = "test_box1";
        ...
        geometry_msgs::msg::Pose testbox1_pose;
        testbox1_pose.orientation = euler2Quaternion_deg(-45, 12, 0);
        testbox1_pose.position.x = -0.1;
        testbox1_pose.position.y = -0.1;
        testbox1_pose.position.z = 0.3;

        testbox1.primitives.push_back(primitive);
        testbox1.primitive_poses.push_back(testbox1_pose);
        testbox1.operation = testbox1.ADD;

        // test box 2
        moveit_msgs::msg::CollisionObject testbox2;
        testbox2.header.frame_id = move_group_interface.getPlanningFrame();
        testbox2.id = "test_box2";
        ...
        geometry_msgs::msg::Pose testbox2_pose;
        testbox2_pose.orientation = euler2Quaternion_deg(65, -12, -5);
        testbox2_pose.position.x = 0.0; // -0.02
        testbox2_pose.position.y = 0.25;
        testbox2_pose.position.z = 0.37;

        testbox2.primitives.push_back(primitive);
        testbox2.primitive_poses.push_back(testbox2_pose);
        testbox2.operation = testbox2.ADD;

        // adding collision objects
        collision_objects.push_back(testbox1);
        collision_objects.push_back(testbox2);

        planning_scene_interface.addCollisionObjects(collision_objects);
    }

    // Box constraint 1
    moveit_msgs::msg::PositionConstraint box_constraint1;
    box_constraint1.header.frame_id = move_group_interface.getPoseReferenceFrame();
    box_constraint1.link_name = move_group_interface.getEndEffectorLink();

    shape_msgs::msg::SolidPrimitive primitive_box_constraint1;
    primitive_box_constraint1.type = shape_msgs::msg::SolidPrimitive::BOX;
    primitive_box_constraint1.dimensions = {0.2, 0.2, 0.6};
    box_constraint1.constraint_region.primitives.emplace_back(primitive_box_constraint1);

    geometry_msgs::msg::Pose constraint_box_pose1;
    constraint_box_pose1.position.x = -0.1;
    constraint_box_pose1.position.y = -0.1;
    constraint_box_pose1.position.z = 0.3;
    constraint_box_pose1.orientation = euler2Quaternion_deg(-45, 12, 0);
    box_constraint1.constraint_region.primitive_poses.emplace_back(constraint_box_pose1);
    box_constraint1.weight = 1.0;

    // Box constraint 2
    moveit_msgs::msg::PositionConstraint box_constraint2;
    box_constraint2.header.frame_id = move_group_interface.getPoseReferenceFrame();
    box_constraint2.link_name = move_group_interface.getEndEffectorLink();

    shape_msgs::msg::SolidPrimitive primitive_box_constraint2;
    primitive_box_constraint2.type = shape_msgs::msg::SolidPrimitive::BOX;
    primitive_box_constraint2.dimensions = {0.2, 0.2, 0.6};
    box_constraint2.constraint_region.primitives.emplace_back(primitive_box_constraint2);

    geometry_msgs::msg::Pose constraint_box_pose2;
    constraint_box_pose2.position.x = 0.0;
    constraint_box_pose2.position.y = 0.25;
    constraint_box_pose2.position.z = 0.37;
    constraint_box_pose2.orientation = euler2Quaternion_deg(65, -12, -5);
    box_constraint2.constraint_region.primitive_poses.emplace_back(constraint_box_pose2);
    box_constraint2.weight = 1.0;

    // setting constraints
    moveit_msgs::msg::Constraints mixed_constraints;
    mixed_constraints.position_constraints.emplace_back(box_constraint1);
    std::cout << "jetzt ist die box 1 eingeschalten" << std::endl;
    mixed_constraints.position_constraints.emplace_back(box_constraint2);
    std::cout << "jetzt ist die box 2 eingeschalten" << std::endl;
